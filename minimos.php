...
<head>
    ...
    <title>Inventario | Toolcrib manager</title>
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-12 col-md-2 text-end">
                            <a href="nueva-salida.php" target="_blank"><div class="btn btn-warning">Capturar <i class="align-middle" data-feather="plus-circle"></i></div></a>
                        </div>
                        <div class="col-12 col-md-2 text-end">
