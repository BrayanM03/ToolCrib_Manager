    ...
    <div class="col-12 col-md-8">
        <div class="card">
            <div class="card-header text-center">
                <div class="row">
                    ...
                    <div class="col-12 col-md-11">
                        <h5 class="card-title mb-0" id="title-card">Actualiza los datos del producto</h5>
                    </div>
                </div>
            ...
            <div class="card-body" id="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-12 col-md-6">
                        <label for="codigo" id="label-codigo" codigo="">Codigo</label>
                        <!-- <select name="proveedor" class="form-control" id="proveedor"></select> -->
                ...
                <div class="row mb-3">
                    <div class="col-12 col-md-6">
                        <div class="btn btn-primary" onclick="editarProducto(<?php echo $_GET['id_product']; ?>)">Actualizar</div>
                    </div>
                </div>
