...
$fecha = date("Y-m-d");
        ...
        //ITERACIONES
           ...
           $hoja_activa->setCellValue('C1', 'Reporte de inventario ToolCrib --- fecha: ' . $fecha);
         ...
         //   $columnFilter = $autofilter->getColumn('D');
            ...
            $hoja_activa->setCellValue('M3', 'Estatus');
            ...
            if($cantidad_resultado == 0){
                ...
                while ($row = array_shift($arreglo)) {
                    ...
                    $hoja_activa->setCellValue('D'.$i, $row['costo']);
                    $hoja_activa->setCellValue('E'.$i, $row['stock']);
                    $hoja_activa->setCellValue('F'.$i, $row['minimo']);
                    $hoja_activa->setCellValue('G'.$i, $row['maximo']);
                    ...
                    $hoja_activa->setCellValue('L'.$i, $row['proveedor']);
                    $hoja_activa->setCellValue('M'.$i, $row['estatus']);
                    $i++;
                }
