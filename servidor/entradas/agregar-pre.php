<?php
    ...
    while($row = $re->fetch(PDO::FETCH_OBJ)){
        ...
        $nueva_cantidad = $cantidad_act + $cantidad;
        ...
        $response = array("status"=> true, "mensj"=>"Los datos se insertaron correctamente", "cantidad_restante"=>$nueva_cantidad);
            ...
            $nueva_cantidad = $cantidad + $cantidad_act;
                    ...
                    $response = array("status"=> true, "mensj"=>"Los datos se actualizarón correctamente", "cant_restante" => $nueva_cantidad);
