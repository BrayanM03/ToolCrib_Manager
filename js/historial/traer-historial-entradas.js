...
$(document).ready(function () {
    ...
    tabla = $('#example').DataTable({
        ...
        serverSide: true,
        ajax:{
            url: 'servidor/historial/server_processing-entradas.php?sucursal_id=' + sucursal_id,
            dataType: 'json'
        },
        responsive: true,
        order: [0, 'desc'],
            ...
            { data:null, title:'Opciones', render: function(row){
                ...
                <div class='row'>
                    <div class='col-12 col-md-12'>
                        <div class="btn btn-primary" onclick="verTicket(${row[0]})"><i class="fa-solid fa-eye"></i></div>
