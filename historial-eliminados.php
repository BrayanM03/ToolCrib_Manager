...
<head>
    ...
    <title>Historial entradas | Toolcrib manager</title>
...
<body>
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row mb-2">
                        <div class="col-12 col-md-6">
                            <h1 class="h3 mb-3">Historial de productos eliminados</h1>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">En esta tabla se encuentra el historico de productos eliminados del catalogo</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
    ...
    <!-- Mis scripts -->
    <script src="js/historial/traer-historial-eliminados.js"></script>
