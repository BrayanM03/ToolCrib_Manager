...
<body>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">En esta tabla se encuentra el registro de entrada de material</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
    ...
    <!-- Mis scripts -->
    <script src="js/historial/traer-historial-entradas.js"></script>
    <script src="js/historial/opciones-entradas.js"></script>
